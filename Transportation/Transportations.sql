...
VALUES ('Chase Bank', '11213145', '00004563','68','0'), --101
		...
		('America Bank', '71123454', '000003245','0','68'), --105
		('Chase Bank', '11111235', '00004563','0','64'), --106
		('Chase Bank', '51111237', '00004563','0','114'), --107
		('American Bank', '11246874', '000003295','0','128'); --108
...
CREATE TABLE Passengers(
	 ...
	 DriverID int FOREIGN KEY REFERENCES Drivers(DriverID) NOT NULL,
	 PaymentID int FOREIGN KEY REFERENCES Payments(PaymentID) NOT NULL,
     TransportID int FOREIGN KEY REFERENCES Transports(TransportID) NOT NULL,
	 FirstName varchar (50) NOT NULL,
	 LastName varchar (50) NOT NULL,
	 DateOfBirth varchar (50) NOT NULL,
	 EmailAddress varchar (50) NOT NULL,
...
ADD TripNumberID int REFERENCES TripNumber(TripNumberID) ;
